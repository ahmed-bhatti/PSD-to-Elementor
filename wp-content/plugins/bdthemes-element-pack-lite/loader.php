...
class Element_Pack_Loader
{
    ...
    public function element_pack_init()
    {
        ...
        if ('on' === $context_menu) {
            $this->element_pack_context_menu_settings_init();
        }
    }

    /**
     * This an extra feature for show right click context menu for website.
     * @return void
     */
    public function element_pack_context_menu_settings_init()
    {
