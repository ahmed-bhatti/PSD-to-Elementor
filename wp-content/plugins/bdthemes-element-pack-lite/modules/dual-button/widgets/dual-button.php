	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a .bdt-dual-button-a-icon' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a:hover .bdt-dual-button-a-icon' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b .bdt-dual-button-b-icon' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b:hover .bdt-dual-button-b-icon' => 'color: {{VALUE}};',
